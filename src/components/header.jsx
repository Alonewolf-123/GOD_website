    ...
    return (
        <header id='header'>
            <div className='intro intro-text'>
                ...
                <img src={isMobile ? playgame_index_banner_mobile : bannerDesktopImg} alt="" onLoad={props.onLoad}></img>
                ...
                {
                    !isMobile && <a href='/play' className='btn btn-custom btn-lg page-scroll'>
                        {isMobile ? "" : "PLAY NOW"}
